...
[源码](https://github.com/lcctoor/pip/tree/main/openai2_)

# 安装或更新

（首选，更新较快）`pip install --upgrade git+https://github.com/lcctoor/pip.git@main#subdirectory=openai2_`

（备选，更新较慢）`pip install --upgrade openai2`
