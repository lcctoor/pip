...
[源码](https://github.com/lcctoor/pip/tree/main/skk_/skk/miumapp)

# 安装或更新

```
pip install --upgrade git+https://github.com/lcctoor/pip.git@main#subdirectory=skk_
```
...
运行后，若显示出与图片 [效果图](https://raw.githubusercontent.com/lcctoor/pip/refs/heads/main/skk_/skk/miumapp/static/DemoUI.png) 所示一致的效果，则说明安装成功。
